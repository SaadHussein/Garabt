...
const ScoreSection = () => {
  ...
  return (
    <div className="py-10 max-[550px]:py-5 flex items-center justify-center flex-col">
      ...
      <div className="w-full px-5 max-w-[1365px] business-rating-top mx-auto">
        <div className="business-rating-card total-rating-card ">
          <div className="business-rating-content padding-in-small-screens">
